...
public final class LocalRowDataNexmarkBenchmark {
    ...
    static RunResult run(long events, String query, boolean streamFusion, String backend, int parallelism)
        ...
        return new RunResult(
                ...
                StreamFusionPlannerFactory.nativePlanBatchCount(),
                ...
                StreamFusionPlannerFactory.nativeMultiJoinBatchCount(),
    ...
    static final class RunResult {
        ...
        private final long nativePlanBatches;
        ...
        private final long nativeMultiJoinBatches;
        ...
        private RunResult(
            ...
            this.nativePlanBatches = nativePlanBatches;
            ...
            this.nativeMultiJoinBatches = nativeMultiJoinBatches;
        ...
        long nativeMatchRecognizeBatches() {
            return nativeMatchRecognizeBatches;
        }
