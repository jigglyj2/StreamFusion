...
/** Opt-in official Q8 parity through ordinary planner selection and the Nexmark RowData source. */
...
class NexmarkQ8ProductionIT {
    ...
    void distinctWindowsAndCompositeJoinPreserveCompleteNexmarkResults(String backend) throws Exception {
