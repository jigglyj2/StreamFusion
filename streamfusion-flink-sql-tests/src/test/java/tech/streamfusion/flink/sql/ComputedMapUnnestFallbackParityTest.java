...
class ComputedMapUnnestFallbackParityTest extends SqlParityTestSupport {
    @Test
    void fallbackUnnestEvaluatesMapConstructorDuringWholePlanFallback() throws Exception {
    ...
    @Test
    void fallbackUnnestEvaluatesMapKeysDuringWholePlanFallback() throws Exception {
        assertFallbackDataStreamParity(
    ...
    @Test
    void fallbackUnnestEvaluatesNullableMapValuesDuringWholePlanFallback() throws Exception {
