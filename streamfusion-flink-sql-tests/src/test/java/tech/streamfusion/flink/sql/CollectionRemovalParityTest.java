...
class CollectionRemovalParityTest extends SqlParityTestSupport {
    @Test
    void arrayRemoveMatchesFlinkForNonNullNeedles() throws Exception {
        assertDataStreamParity(
                "SELECT ARRAY_REMOVE(metric, 2), ARRAY_REMOVE(metric, 42) FROM array_input",
                Types.OBJECT_ARRAY(Types.INT),
                DataTypes.ARRAY(DataTypes.INT()),
                Arrays.asList(
                        Row.of((Object) new Integer[] {1, 2, null, 2, 3}),
