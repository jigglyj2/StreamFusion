...
class MultiJoinOpaquePayloadTypeFallbackParityTest extends SqlParityTestSupport {
    @Test
    void statePreservesEveryFlinkLogicalPayloadTypeByteForByte() throws Exception {
        ...
        SqlFallbackAssertions.nativeBatchesAreZero(StreamFusionPlannerFactory.nativeMultiJoinBatchCount());
    }
