...
class GroupAggregateFallbackParityTest extends SqlParityTestSupport {
    @Test
    ...
    void twoPhaseMiniBatchMatchesFlinkAcrossLocalAndGlobalBundleBoundaries() throws Exception {
        ...
        assertThat(streamFusion).isEqualTo(flink);
        SqlFallbackAssertions.nativeBatchesAreZero(StreamFusionPlannerFactory.nativeGroupAggregateBatchCount());
        SqlFallbackAssertions.nativeBatchesAreZero(StreamFusionPlannerFactory.nativeLocalGroupAggregateBatchCount());
        SqlFallbackAssertions.admission();
    }
    ...
    @Test
    void globalAggregateFallsBackAndMatchesFlinkByteForByte() throws Exception {
    ...
    @Test
    void splitDistinctIncrementalAggregateSupportsAllAggregateCallsFiltersAndRetractions() throws Exception {
