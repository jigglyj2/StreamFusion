...
class ComputedArrayOrderingUnnestFallbackParityTest extends SqlParityTestSupport {
    @Test
    void fallbackUnnestObservesArraySortDirectionAndNullOrdering() throws Exception {
    ...
    @Test
    void fallbackUnnestObservesNegativeArraySliceBounds() throws Exception {
        assertFallbackDataStreamParity(
    ...
    @Test
    void fallbackUnnestEvaluatesPerRowArraySliceBoundsDuringWholePlanFallback() throws Exception {
