...
class StatefulOpaquePayloadTypeFallbackParityTest extends SqlParityTestSupport {
    @Test
    void overStatePreservesEveryFlinkLogicalPartitionAndPayloadTypeByteForByte() throws Exception {
        ...
        SqlFallbackAssertions.nativeBatchesAreZero(StreamFusionPlannerFactory.nativeOverAggregateBatchCount());
    ...
    void windowStatePreservesEveryFlinkLogicalPayloadTypeByteForByte() throws Exception {
        ...
        assertThat(streamFusion).isEqualTo(flink);
        SqlFallbackAssertions.nativeBatchesAreZero(StreamFusionPlannerFactory.nativeWindowRankBatchCount());
        SqlFallbackAssertions.admission();
    }
    ...
    void windowDeduplicateTimerOutputPreservesEveryFlinkLogicalPayloadTypeByteForByte() throws Exception {
        ...
        assertThat(streamFusion).isEqualTo(flink);
        SqlFallbackAssertions.nativeBatchesAreZero(StreamFusionPlannerFactory.nativeWindowDeduplicateBatchCount());
        SqlFallbackAssertions.admission();
    }
    ...
    @Test
    void boundedSortMergeJoinPreservesAllJoinTypesDuringFallbackByteForByte() throws Exception {
    ...
    void changelogNormalizeStatePreservesEveryFlinkLogicalPayloadTypeByteForByte() throws Exception {
        ...
        assertThat(streamFusion).isEqualTo(flink);
        SqlFallbackAssertions.nativeBatchesAreZero(StreamFusionPlannerFactory.nativeChangelogNormalizeBatchCount());
        SqlFallbackAssertions.admission();
    }
    ...
    void matchRecognizeStatePreservesEveryFlinkLogicalPartitionAndPayloadTypeByteForByte() throws Exception {
        ...
        assertThat(streamFusion).isEqualTo(flink);
        SqlFallbackAssertions.nativeBatchesAreZero(StreamFusionPlannerFactory.nativeMatchRecognizeBatchCount());
        SqlFallbackAssertions.admission();
    }
