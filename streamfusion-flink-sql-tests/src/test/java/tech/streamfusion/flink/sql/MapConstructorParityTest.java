...
class MapConstructorParityTest extends SqlParityTestSupport {
    @Test
    void uniqueLiteralKeyMapConstructorMatchesFlink() throws Exception {
        assertDataStreamParity(
                "SELECT MAP['a', metric, 'b', metric + 1] FROM int_input",
                Types.INT,
                DataTypes.INT(),
