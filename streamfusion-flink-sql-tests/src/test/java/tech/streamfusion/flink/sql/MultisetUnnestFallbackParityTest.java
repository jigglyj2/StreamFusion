...
class MultisetUnnestFallbackParityTest extends SqlParityTestSupport {
    ...
    @Test
    void fallbackMultisetUnnestRepeatsElementsAndAssignsExpandedOrdinality() throws Exception {
    ...
    @Test
    void fallbackLeftMultisetUnnestNullExtendsNullAndEmptyInputs() throws Exception {
        assertFallbackDataStreamParity(
    ...
    @Test
    void fallbackMultisetUnnestRepeatsAndFlattensNonNullRowElements() throws Exception {
    ...
    @Test
    void fallbackMultisetUnnestFlattensRowsContainingScalarArrays() throws Exception {
        LinkedHashMap<Row, Integer> populated = new LinkedHashMap<>();
