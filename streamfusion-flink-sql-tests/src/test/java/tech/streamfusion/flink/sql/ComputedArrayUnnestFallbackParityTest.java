...
class ComputedArrayUnnestFallbackParityTest extends SqlParityTestSupport {
    @Test
    void fallbackUnnestEvaluatesArrayConstructorDuringWholePlanFallback() throws Exception {
    ...
    @Test
    void fallbackLeftUnnestEvaluatesNullableArrayFunctionOperand() throws Exception {
        assertFallbackDataStreamParity(
    ...
    @Test
    void fallbackUnnestConsumesCheckedElementArrayDuringWholePlanFallback() throws Exception {
        assertFallbackDataStreamParity(
    ...
    @Test
    void fallbackLeftUnnestReadsNestedArrayFieldDuringWholePlanFallback() throws Exception {
        assertFallbackDataStreamParity(
