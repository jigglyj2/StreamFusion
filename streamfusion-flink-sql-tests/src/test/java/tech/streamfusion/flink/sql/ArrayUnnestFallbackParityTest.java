...
class ArrayUnnestFallbackParityTest extends SqlParityTestSupport {
    ...
    @Test
    void fallbackInnerArrayUnnestMatchesFlinkCardinalityNullsAndDuplicates() throws Exception {
    ...
    @Test
    void fallbackLeftArrayUnnestNullExtendsNullAndEmptyArrays() throws Exception {
        assertFallbackDataStreamParity(
    ...
    @Test
    void fallbackArrayUnnestPreservesEveryInputRowKindForEachElement() throws Exception {
    ...
    @Test
    void fallbackArrayUnnestSupportsVariableAndFixedWidthScalarBoundaries() throws Exception {
        assertFallbackDataStreamParity(
    ...
    @Test
    void fallbackArrayUnnestWithOrdinalityMatchesFlinkOneBasedPositions() throws Exception {
        assertFallbackDataStreamParity(
    ...
    @Test
    void fallbackLeftArrayUnnestWithOrdinalityNullExtendsBothFields() throws Exception {
        assertFallbackDataStreamParity(
    ...
    @Test
    void fallbackArrayOfRowsUnnestFlattensFieldsAndPreservesNullElements() throws Exception {
        assertFallbackDataStreamParity(
    ...
    @Test
    void fallbackLeftArrayOfRowsDistinguishesNullElementsFromSyntheticRows() throws Exception {
    ...
    @Test
    void fallbackArrayOfRowsPreservesScalarArrayFieldsWithoutFlatteningThem() throws Exception {
        java.util.List<Row> inputs = Arrays.asList(
                Row.of((Object) new Row[] {
    ...
    @Test
    void fallbackNestedArrayUnnestPreservesEachInnerArrayAndOrdinality() throws Exception {
        java.util.List<Row> inputs = Arrays.asList(
    ...
    @Test
    void fallbackDeeplyNestedArrayUnnestPreservesTheNestedElement() throws Exception {
        java.util.List<Row> inputs = Arrays.asList(
                Row.of((Object) new Integer[][][] {
    ...
    @Test
    void fallbackRowArrayUnnestPreservesDeeplyNestedArrayFields() throws Exception {
        java.util.List<Row> inputs = Arrays.asList(
    ...
    @Test
    void fallbackRowArrayUnnestPreservesNestedMapFields() throws Exception {
