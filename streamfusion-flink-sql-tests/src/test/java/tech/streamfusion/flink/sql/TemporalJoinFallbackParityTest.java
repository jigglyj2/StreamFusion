...
class TemporalJoinFallbackParityTest extends SqlParityTestSupport {
    ...
    void versionedEventTimeJoinWithResidualConditionMatchesFlinkByteForByte() throws Exception {
        ...
        SqlFallbackAssertions.nativeBatchesAreZero(StreamFusionPlannerFactory.nativeTemporalJoinBatchCount());
