...
/** Checks selected-node plumbing while ordinary Top-1 production admission remains separately gated. */
class SharedTopOneTopologyTest {
    @Test
    void topOneAndAdjacentCalcsHaveOneArrowRuntimeAndOneStateOwner() throws Exception {
