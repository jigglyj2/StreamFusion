...
public final class StreamFusionBatchExecOverAggregate extends ExecNodeBase<RowData> implements BatchExecNode<RowData> {
    private static final String TRANSLATOR_CLASS =
            "tech.streamfusion.flink.over.StreamFusionBoundedOverAggregateTranslator";
    ...
    protected Transformation<RowData> translateToPlanInternal(PlannerBase planner, ExecNodeConfig config) {
        ...
        try {
            ...
            Transformation<RowData> result = (Transformation<RowData>) method.invoke(
                    ...
                    planner.getExecEnv());
            if (result == null) {
                throw new IllegalStateException("A selected StreamFusion bounded OVER aggregate failed translation");
            }
            return result;
