...
public final class StreamFusionBatchExecGlobalGroupAggregate extends ExecNodeBase<RowData>
    ...
    public StreamFusionBatchExecGlobalGroupAggregate(
        ...
        super(
                ...
                new ExecNodeContext("streamfusion-batch-exec-global-group-aggregate_1"),
                config,
    ...
    protected Transformation<RowData> translateToPlanInternal(PlannerBase planner, ExecNodeConfig config) {
        ...
        try {
            ...
            throw new IllegalStateException("Could not invoke the bounded native global aggregate", failure);
        } catch (InvocationTargetException failure) {
            throw new IllegalStateException("Bounded native global aggregate failed", failure.getCause());
        }
    }
}
