...
class StringTranslatePlanTest {
    @Test
    void expressionValuedAlphabetsRoundTrip() throws Exception {
        Expression expression = Expression.newBuilder()
                .setStringTranslate(StringTranslate.newBuilder()
                        .setValue(input(0))
                        .setSourceCharacters(input(1))
                        .setTargetCharacters(input(2)))
                .build();
