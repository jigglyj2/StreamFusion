...
abstract class StreamFusionExpressionTranslator extends StreamFusionProjectionTranslator {
    protected static String expressionFailure(
        ...
        if (complexFailure == null) {
            complexFailure = StreamFusionArrayConstructorTranslator.failureReason(expression);
        }
        if (complexFailure == null) {
            complexFailure = StreamFusionRowConstructorTranslator.failureReason(expression);
        }
        if (complexFailure == null) {
        ...
        if (complexFailure == null) {
            complexFailure = StreamFusionStringFunctionTranslator.failureReason(expression);
        }
        if (complexFailure == null) {
            complexFailure = StreamFusionCharacterClassifierTranslator.failureReason(expression);
        }
        if (complexFailure == null) {
            complexFailure = StreamFusionNondeterministicFunctionTranslator.failureReason(expression);
        }
        if (complexFailure == null) {
            complexFailure = StreamFusionRegexFunctionTranslator.failureReason(expression);
        }
        if (complexFailure == null) {
            complexFailure = StreamFusionCharsetFunctionTranslator.failureReason(expression);
        }
        if (complexFailure == null) {
            complexFailure = StreamFusionFormattingFunctionTranslator.failureReason(expression);
        }
        if (complexFailure == null) {
        ...
        if (complexFailure == null) {
            complexFailure = StreamFusionBinaryFunctionTranslator.failureReason(expression);
        }
        if (complexFailure == null) {
            complexFailure = StreamFusionJsonFunctionTranslator.failureReason(expression);
        }
        if (complexFailure == null) {
            complexFailure = StreamFusionUrlFunctionTranslator.failureReason(expression);
        }
        if (complexFailure == null) {
        ...
        if (complexFailure == null) {
            complexFailure = StreamFusionScalarExtremumTranslator.failureReason(expression);
        }
        if (complexFailure != null) {
    ...
    protected static Expression recursiveComparison(
        ...
        Expression exactNumeric = StreamFusionExactNumericComparisonTranslator.translate(
                leftExpression, rightExpression, leftType, rightType, operator, inputType);
        if (exactNumeric != null) return exactNumeric;
