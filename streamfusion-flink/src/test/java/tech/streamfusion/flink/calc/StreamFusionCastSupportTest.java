...
class StreamFusionCastSupportTest {
    ...
    private static Stream<Arguments> approvedCasts() {
        return Stream.of(
                ...
                Arguments.of(LogicalTypeRoot.INTEGER, LogicalTypeRoot.FLOAT, CastKind.CAST_KIND_INTEGER_TO_FLOAT),
                Arguments.of(LogicalTypeRoot.BIGINT, LogicalTypeRoot.FLOAT, CastKind.CAST_KIND_BIGINT_TO_FLOAT),
                Arguments.of(LogicalTypeRoot.BIGINT, LogicalTypeRoot.DOUBLE, CastKind.CAST_KIND_BIGINT_TO_DOUBLE),
                Arguments.of(LogicalTypeRoot.FLOAT, LogicalTypeRoot.DOUBLE, CastKind.CAST_KIND_FLOAT_TO_DOUBLE),
                Arguments.of(LogicalTypeRoot.DOUBLE, LogicalTypeRoot.FLOAT, CastKind.CAST_KIND_DOUBLE_TO_FLOAT),
                ...
                Arguments.of(LogicalTypeRoot.TINYINT, LogicalTypeRoot.DECIMAL, CastKind.CAST_KIND_TINYINT_TO_DECIMAL),
                Arguments.of(LogicalTypeRoot.SMALLINT, LogicalTypeRoot.DECIMAL, CastKind.CAST_KIND_SMALLINT_TO_DECIMAL),
                Arguments.of(LogicalTypeRoot.INTEGER, LogicalTypeRoot.DECIMAL, CastKind.CAST_KIND_INTEGER_TO_DECIMAL),
                Arguments.of(LogicalTypeRoot.BIGINT, LogicalTypeRoot.DECIMAL, CastKind.CAST_KIND_BIGINT_TO_DECIMAL),
                Arguments.of(LogicalTypeRoot.DECIMAL, LogicalTypeRoot.DECIMAL, CastKind.CAST_KIND_DECIMAL_TO_DECIMAL));
    }
}
