...
/** Lifecycle, timers, keyed state, and Arrow C Data boundary for native Window Top-N. */
public final class NativeWindowRankBridge {
    ...
    public static long create(
        ...
        if (handle == 0) {
            throw new IllegalStateException("Native window rank returned a null handle");
        }
        return handle;
    }
    ...
    public static long createRocksDb(
        ...
        long handle = createRocksHandle(
                ...
                memoryLimit);
        if (handle == 0) {
            throw new IllegalStateException("Native RocksDB window rank returned a null handle");
        }
        return handle;
    }
