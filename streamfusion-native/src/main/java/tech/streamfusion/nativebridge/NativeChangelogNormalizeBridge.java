...
/** Persistent Arrow and raw keyed-state boundary for native changelog normalization. */
public final class NativeChangelogNormalizeBridge {
    ...
    public static long create(
        ...
        if (handle == 0) {
            throw new IllegalStateException("Native changelog normalize returned a null handle");
        }
        return handle;
    }
    ...
    public static long createRocksDb(
        ...
        long handle = createRocksHandle(
                ...
                memoryLimit);
        if (handle == 0) {
            throw new IllegalStateException("Native RocksDB changelog normalize returned a null handle");
        }
        return handle;
    }
