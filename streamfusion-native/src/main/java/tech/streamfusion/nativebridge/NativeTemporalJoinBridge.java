...
/** Lifecycle, timers, keyed state, and Arrow C Data boundary for native temporal joins. */
public final class NativeTemporalJoinBridge {
    ...
    public static long create(
        ...
        if (handle == 0) {
            throw new IllegalStateException("Native temporal join returned a null handle");
        }
        return handle;
    }
    ...
    public static long createRocksDb(
        ...
        long handle = createRocksHandle(
                ...
                limit);
        if (handle == 0) {
            throw new IllegalStateException("Native RocksDB temporal join returned a null handle");
        }
        return handle;
    }
