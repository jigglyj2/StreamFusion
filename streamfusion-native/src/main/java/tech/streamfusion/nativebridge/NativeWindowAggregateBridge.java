...
/** Lifecycle, timers, keyed state, and Arrow C Data boundary for native window aggregation. */
public final class NativeWindowAggregateBridge {
    ...
    private static final NativeKeyedStateBridge KEYED_STATE_BRIDGE = NativeKeyedStateBridge.of(
            ...
            NativeWindowAggregateBridge::snapshot,
            NativeWindowAggregateBridge::restore,
            NativeWindowAggregateBridge::checkpointRocks,
            NativeWindowAggregateBridge::importRocksCheckpoint,
            NativeWindowAggregateBridge::destroy);

    private NativeWindowAggregateBridge() {}
    ...
    public static long create(
        ...
        if (handle == 0) {
            throw new IllegalStateException("Native window aggregate returned a null handle");
        }
        return handle;
    }
    ...
    public static long createRocksDb(
        ...
        long handle = createRocksHandle(
                ...
                memoryLimit);
        if (handle == 0) {
            throw new IllegalStateException("Native RocksDB window aggregate returned a null handle");
        }
        return handle;
    }
