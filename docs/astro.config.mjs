  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        { label: 'Development', items: [{ label: 'Planning', slug: 'development/planning' }, { label: 'Metric compatibility', slug: 'development/metrics' }, { label: 'Memory and configuration', slug: 'development/memory-and-configuration' }, { label: 'RocksDB configuration', slug: 'development/rocksdb-configuration' }, { label: 'Native modules and ABI', slug: 'development/native-modules' }, { label: 'SQL test harness', slug: 'development/sql-harness' }, { label: 'Planner integration', slug: 'development/planner-integration' }] },
