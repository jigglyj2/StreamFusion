  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        { label: 'Development', items: [{ label: 'Planning', slug: 'development/planning' }, { label: 'Memory and configuration', slug: 'development/memory-and-configuration' }, { label: 'Native modules and ABI', slug: 'development/native-modules' }, { label: 'SQL test harness', slug: 'development/sql-harness' }, { label: 'Planner integration', slug: 'development/planner-integration' }] },
