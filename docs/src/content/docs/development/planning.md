...
`BatchExecWindowTableFunction`, `BatchExecHashJoin`, `BatchExecAdaptiveJoin`,
`BatchExecSortMergeJoin`, and `BatchExecNestedLoopJoin` nodes, producing distinct bounded
StreamFusion nodes.
