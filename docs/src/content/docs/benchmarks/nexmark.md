...
Q13 now passes ordinary lookup admission with the original legacy CSV side input; its benchmark
catalog integration and release comparison remain pending. q15, q16, and q17 still require an
