---
title: Q16 before native ownership repair
description: Historical Q16 measurements before native RocksDB ownership was corrected.
---

These are historical measurements before the ownership repair in `94d996f0`. See the
[current Q16 report](/StreamFusion/benchmarks/q16-rowdata/) for the corrected release comparison.
...
described below; measurements after that repair are in the current report linked above.
...
with the intended cache ownership. See the current report linked above for corrected release measurements.
