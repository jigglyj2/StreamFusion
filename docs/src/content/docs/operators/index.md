...
| [OVER aggregation](over-aggregation/) | **Partial** (non-time, processing-time, and event-time unbounded-preceding `ROWS`/`RANGE`) | Yes | Native ordered state, timers, and aggregate kernels |
