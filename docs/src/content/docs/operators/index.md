...
| [Joins](joins/) | **Partial** (bounded hash/adaptive/nested-loop plus regular, multi-way, constant-bound interval, and temporal streaming joins) | By join type | Native keyed state, vectorized predicates, and timers |
