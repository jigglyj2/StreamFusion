...
| [ORDER BY](order-by/) | **Partial** (streaming finite Top-N and time-ascending temporal sort) | Yes | Native Top-N or timer/state sort; DataFusion sort for future bounded full sorts |
